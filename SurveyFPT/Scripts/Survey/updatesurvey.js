function check(studentForm) {
        ...
        for (var i = 0; i < arrayTextCompel.length; i++) {
            ...
            for (var j = 0; j < inputCheck.length; j++) {
                if (inputCheck[j].value.trim() == "") {
                    ...
                    arr.push(arrayTextCompel[i].querySelector(".error"));
        ...
        for (var i = 0; i < arrayTextNon.length; i++) {
            ...
            for (var j = 0; j < inputCheck.length; j++) {
                if (inputCheck[j].value.length > 500) {
                    ...
                    arr.push(arrayTextNon[i].querySelector(".error"));
                    f--;
                    break;
                }
                else {
                    ...
                    for (var j = 0; j < inputCheck.length; j++) {
                        if (inputCheck[j].checked == true) {
                            if (inputText.value.trim() == '') {
                                ...
                                arr.push(arrayCheckboxCompel[i].querySelector(".error"));
                                break;
            ...
            for (var j = 0; j < inputCheck.length; j++) {
                if (inputText != null && inputText.value.length >= 1) {
                    if (inputText.value.length > 500) {
                        ...
                        arr.push(arrayCheckboxNon[i].querySelector(".error"));
                        countCheckboxNon--;
                        break;
                ...
                if (inputCheckOption != null && inputCheckOptionText != null) {
                    for (var j = 0; j < inputCheck.length; j++) {
                        ...
                        if (inputCheck[j].checked == false) {
                            ...
                            arr.push(arrayRadioCompel[i].querySelector(".error"));
                        }
            ...
            for (var j = 0; j < inputCheck.length; j++) {
                ...
                if (inputText != null && inputText.value.length >= 1) {
                    if (inputText.value.length > 500) {
                        ...
                        arr.push(arrayRadioNon[i].querySelector(".error"));
                        c--;
                        break;
        ...
        for (var i = 0; i < arrayLevel.length; i++) {
            ...
            for (var j = 0; j < inputCheck.length; j++) {
                if (inputCheck[j].checked == false) {
                    ...
                    arr.push(arrayLevel[i].querySelector(".error"));
                }
                else {
    ...
    if (valid) {
        ...
        for (let i = 0; i < arr.length; i++) {
            if (arr[i].offsetTop < minNumber && arr[i].innerHTML != "") {
                minNumber = arr[i].offsetTop;
            }
        }
        window.scrollTo(0, minNumber - 300);
    }
    return valid;
}
...
function chooseLabelRadio(element) {
...
function chooseLabelBoxLine(element) {
...
var checkSubmitForm = document.getElementById('myFormEdit');
var submitButton = document.getElementById('submitID');
checkSubmitForm.addEventListener('submit', function () {
